...
export function KanbanColumnSkeleton() {
  return (
    <div className="w-[260px] min-w-[260px] shrink-0 rounded-2xl border border-divider bg-background p-3">
...
export function DetailSkeleton() {
  return (
    <div className="max-w-[720px]">
      ...
      <div className="rounded-2xl border border-divider bg-background p-4 md:p-6 mb-4">
      ...
      <div className="rounded-2xl border border-divider bg-background p-4 md:p-6">
