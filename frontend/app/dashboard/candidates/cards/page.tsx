      ...
      {loading ? (
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
            <div key={i} className="rounded-2xl bg-zinc-900/50 border border-zinc-800/60 p-5 animate-pulse">
              <div className="flex items-center gap-3 mb-4">
                <div className="h-11 w-11 rounded-full bg-zinc-700/30 shrink-0" />
                <div className="flex-1">
                  <div className="h-4 w-28 rounded bg-zinc-700/30 mb-2" />
                  <div className="h-3 w-36 rounded bg-zinc-700/30" />
                </div>
              </div>
              <div className="h-3 w-20 rounded bg-zinc-700/30 mb-3" />
          ...
          {candidates.map((candidate) => {
            ...
            return (
              <div
                ...
                className="group rounded-2xl bg-zinc-900/50 border border-zinc-800/60 p-5 cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/30 hover:border-zinc-700/60"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-sm font-semibold text-white truncate m-0 group-hover:text-orange-400 transition-colors">
                      {candidate.name}
                    </h3>
                ...
                <div className="flex items-center justify-between">
                  {stageColor ? (
                    ...
                    <span className="inline-block rounded-full px-2.5 py-0.5 text-[11px] font-medium bg-zinc-800 text-zinc-500">
                      {candidate.currentStage}
                    </span>
                  )}
