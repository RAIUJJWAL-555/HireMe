    ...
    <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="mt-2 block w-full rounded-xl border border-zinc-700/50 bg-zinc-800/80 px-4 py-3 text-sm text-zinc-300 focus:border-orange-500 focus:ring-1 focus:ring-orange-500/20 focus:outline-none transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-2 block w-full rounded-xl border border-zinc-700/50 bg-zinc-800/80 px-4 py-3 text-sm text-zinc-300 focus:border-orange-500 focus:ring-1 focus:ring-orange-500/20 focus:outline-none transition-colors resize-y"
        />
      </div>

      <div>
        <label htmlFor="qualification" className="block text-sm font-medium text-zinc-400">
          Qualification
        </label>
        <input
          id="qualification"
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button
          type="button"
          onClick={() => router.back()}
          className="rounded-xl border border-zinc-700/50 bg-zinc-800/80 px-6 py-2.5 text-sm text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors"
        >
          Cancel
        </button>
      </div>
