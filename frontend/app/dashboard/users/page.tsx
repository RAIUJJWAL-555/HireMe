  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8 md:px-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-semibold text-white m-0">Users</h1>
        <button
      ...
      {showForm && (
        <div className="rounded-2xl border border-zinc-800/60 bg-zinc-900/50 p-4 md:p-6 mb-6">
          <h2 className="text-sm font-semibold text-zinc-400 m-0 mb-4 uppercase tracking-wider">New Recruiter</h2>
          <form onSubmit={handleCreate} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-700/50 bg-zinc-800/60 px-4 py-2.5 text-sm text-white placeholder-zinc-600 focus:border-orange-500 focus:ring-1 focus:ring-orange-500/20 focus:outline-none transition-colors"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-zinc-700/50 bg-zinc-800/60 px-4 py-2.5 text-sm text-white focus:border-orange-500 focus:ring-1 focus:ring-orange-500/20 focus:outline-none transition-colors"
                >
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="rounded-full border border-zinc-700/50 bg-zinc-800/80 px-5 py-2 text-sm text-zinc-400 hover:text-white hover:border-zinc-600 transition-colors cursor-pointer"
              >
                Cancel
              </button>
            </div>
              ...
              {users.map((u) => (
                <tr key={u.id} className="border-b border-zinc-800/60">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-zinc-700/50 text-xs font-bold text-white">
                  ...
                  <td className="px-4 py-3 text-zinc-400">{u._count.jobs}</td>
